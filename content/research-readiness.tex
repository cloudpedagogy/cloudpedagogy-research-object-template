...
\bottomrule\noalign{}
\endlastfoot
\textbf{Research question clearly defined} & ☐ & \textgreater{} REPLACE
THIS: Add notes here \\
\textbf{Dataset described} & ☐ & \textgreater{} REPLACE THIS: Add notes
here \\
\textbf{Methods documented} & ☐ & \textgreater{} REPLACE THIS: Add notes
here \\
\textbf{Results interpreted} & ☐ & \textgreater{} REPLACE THIS: Add
notes here \\
\textbf{Limitations stated} & ☐ & \textgreater{} REPLACE THIS: Add notes
here \\
\end{longtable}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, arc=.35mm, rightrule=.15mm, toprule=.15mm, breakable, colback=white, leftrule=.75mm, bottomrule=.15mm]
...
\begin{quote}
\textbf{0--5 incomplete items} → Research Ready for Internal Review

\textbf{6--10 incomplete items} → Requires Governance Review

\textbf{\textgreater10 incomplete items} → Early Draft Stage
\end{quote}
