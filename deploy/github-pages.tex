...
\chapter{Deploying to GitHub Pages}\label{deploying-to-github-pages}
...
\end{Shaded}
\item
  Quarto will build the site, create a \texttt{gh-pages} branch, and
  push the static assets.
\item
  In your GitHub repository settings, ensure Pages is set to deploy from
